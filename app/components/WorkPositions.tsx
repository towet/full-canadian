...
const previouslyDefinedPositions = [
  ...
  },
  {
    ...
    description: "Protect people and property while ensuring safety in diverse environments. Gain valuable experience with opportunities for career advancement.",
    salary: "$2,773 - $3,466",
  ...
  },
  {
    ...
    description: "Support the kitchen team by preparing ingredients and maintaining cleanliness. Start your journey in the culinary world with hands-on experience.",
    salary: "$2,600 - $2,960",
  ...
  {
    title: "Bartender",
    description: "Mix drinks, serve and create memorable experiences for patrons in a fast-paced environment. Enjoy tips and competitive earnings in vibrant settings.",
