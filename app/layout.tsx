...
export const metadata: Metadata = {
  title: 'Canadian Visa Application - Your Path to a New Life',
  description: 'Seamless and efficient Canadian visa application process. Start your journey to Canada today!',
}
        ...
        <header className="fixed top-0 left-0 right-0 bg-white bg-opacity-90 shadow-md z-50">
          <nav className="container mx-auto px-6 py-3">
            <div className="flex justify-between items-center">
              ...
              <Button className="bg-red-600 hover:bg-red-700 text-white transition-colors">Apply Now</Button>
            </div>
          </nav>
        </header>
